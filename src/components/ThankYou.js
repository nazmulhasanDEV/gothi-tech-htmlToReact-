...
export class ThankYou extends Component {
    render() {
        return (
          ...
          <main>
            {/* start banner */}
            <section className="banner banner_4 banner-padding">
              <div className="container">
                <div className="row justify-content-between align-items-center gutter-40">
                  <div className="col-lg-6 col-xl-6">
                    <div className="banner-caption">
                      <h1 className="banner-title banner-title_3 thanks-title">
                        Thank You
                      </h1>
                      <span className="banner-subtitle mt-30 text-capitalize  fw-bold">
                        your registration successfully completed
                      </span>
                      <p>
                        your application is keep pending we will
                        contact within 3 working days and will activate your account
                      </p>
                      <div className="btn-wrap  mt-40">
                        <a href="#" className="btn min-180">got it</a>
                      </div>
                    </div>
                  </div>{/* end col */}
                  <div className="col-lg-6 col-xl-5">
                    <div className="banner2-img">
                      <img src="assets/img/thankyou_img1.png" className="img-fluid" alt="" />
                    </div>
                    <div className="helpline text-end mt-30">
                      <p><img src="assets/img/dialer_icon1.png" alt="" /></p>
                      <p className="fw-bold">For Help : <a href="tel:+8809678221224" className="color_secondary">+88 09678221224</a></p>
                    </div>
                  </div>{/* end col */}
                </div>{/* end row */}
              </div>{/* end container */}
