                  ...
                  <ul className="navbar-nav ms-auto main-menu">
                    ...
                    <li className="nav-item dropdown">
                      ...
                      <ul className="dropdown-menu" aria-labelledby="navbarDropdown2">
                        <li><a className="dropdown-item" href="#">Sign up to Drive</a></li>
                      </ul>
                    </li>
                  </ul>{/* end main-menu */}
          ...
          <main>
                ...
                <div className="row align-items-center gutter-40">
                  <div className="col-lg-7">
                    <div className="banner-caption">
                      <span className="banner-subtitle">Make money. Let's move on to life!</span>
                      <h1 className="banner-title banner-title_3">
                        Now be your own boss! Start today.
                      </h1>
                      <div className="btn-wrap mt-40">
                        <form action="#" className="gothi-form_1">
                          <div className="floating-label-group login-group">
                            <input id="partnerApply" type="tel" className="form-control me-3" required />
                            <label htmlFor="partnerApply" className="floating-label">
                              Enter Your Mobile Number
                            </label>
                            <button type="submit" className="btn">APPLY TO DRIVE</button>
                          </div>
                          <div className="form-check terms-check mt-30 ms-3">
                            <input className="form-check-input" type="checkbox" defaultValue id="partnerApplyTerms" />
                            <label className="form-check-label" htmlFor="partnerApplyTerms">
                              I agree to Gothi's <a href="#">Terms of Service</a>
                            </label>
                          </div>
                        </form>
                      </div>
                  ...
                  <div className="col-lg-5">
                    <div className="banner2-img">
                      <img src="assets/img/banner_img4.png" className="img-fluid" alt="" />
                    </div>
                  </div>{/* end col */}
                </div>{/* end row */}
              </div>{/* end container */}
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp">
                    <div className="feature">
                      ...
                      <h3 className="feature-title">
                        <a href="#">Reliable earnings</a>
                      </h3>
                      <p>
                        The Gothi Driver app and its features help you make money you can depend on.
                        When you're ready, cash out instantly.
                      </p>
                      <div className="feature-btn">
                        <a href="#" className="read-more">Make money</a>
                      </div>
                    </div>
                  </div>{/* end col */}
                  <div className="col-lg-4 col-md-6 wow fadeInUp">
                    <div className="feature">
                      ...
                      <h3 className="feature-title">
                        <a href="#">A few necessities</a>
                      </h3>
                      <p>
                        You’ll need to meet the age requirement for your region, have a smartphone, and pass an
                        online DMV and background check. Requirements vary across cities.
                      </p>
                      <div className="feature-btn">
                        <a href="#" className="read-more">Find your Areas</a>
                      </div>
                    </div>
                  </div>{/* end col */}
                  <div className="col-lg-4 col-md-6 wow fadeInUp">
                    <div className="feature">
                      ...
                      <h3 className="feature-title">
                        <a href="#">Need a vehicle?</a>
                      </h3>
                      <p>
                        Get one when you want from our trusted Express Drive partners. Also included: insurance,
                        maintenance, and unlimited miles to earn with Gothi.
                      </p>
                      <div className="feature-btn">
                        <a href="#" className="read-more"> Call Partner</a>
                      </div>
                    </div>
                  </div>{/* end col */}
                </div>{/* end row */}
            ...
            <div className="overview-wrap">
              <div className="container">
                ...
                >
                  <div className="item">
                    <img className="img-fluid" src={require('../images/overview_img1.png').default} alt="" />
            ...
            <div className="stepping-wrapper bg_pink section-padding">
              <div className="container">
                <div className="row gutter-30 align-items-center justify-content-center">
                  <div className="col-md-6 col-lg-5 wow fadeInUp">
                    <h2 className="section-title mb-0">How does gothi partner work?</h2>
                  </div>{/* end col */}
                  <div className="col-md-6 col-lg-5 text-md-center">
                    <div className="step-wrap wow fadeInUp">
                      <p className="mb-0"><a href="#">Apply to drive</a> to approved</p>
                    </div>
                  </div>{/* end col */}
                </div>{/* end row */}
              </div>{/* end container */}
            </div>{/* end stepping wrapper */}
            {/* start partner galley */}
            <div className="partner-gallery section-padding">
              <div className="container">
                <div className="row gutter-30">
                  <div className="col-md-6 wow fadeInUp">
                    <div className="partner-gallery-thumbs">
                      <a href="#"><img src="assets/img/video_thumbs1.jpg" className="img-fluid" alt="" /></a>
                      <div className="gallery-overlay">
                        <a href="https://www.youtube.com/watch?v=Lv6iQW2s7So" className="play-btn">
                  ...
                  <div className="col-md-6 wow fadeInUp">
                    <div className="partner-gallery-thumbs">
                      <a href="#"><img src="assets/img/video_thumbs2.jpg" className="img-fluid" alt="" /></a>
                      <div className="gallery-overlay">
                        <a href="https://www.youtube.com/watch?v=Lv6iQW2s7So" className="play-btn">
                          <i className="fas fa-play" />
                        </a>
                ...
                <div className="row text-center">
                  <h2 className="section-title mb-20 mt-60">Make money : flexibility, and support</h2>
                </div>
              </div>{/* end container */}
            </div>{/* end partener gallery */}
          </main>
          {/* footer */}
