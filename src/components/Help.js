    ...
    render() {
        return (
          ...
          <main>
            ...
            <div className="section-padding  help-menu">
              <div className="container">
                <div className="row text-center">
                  <div className=" col-md-12">
                    <h2 className="section-title">Important Articles</h2>
                    <ul className="investor-menu ">
                      <li><a href="#">Lost and Found for riders </a></li>
                      <li><a href="#"> How and when driver pay is calculated</a></li>
                      <li><a href="#">Report an accident</a></li>
            ...
            <div className="section-padding bg_gray help-section">
              <div className="container">
                <h2 className="section-title text-center">All Help Topics</h2>
                <div className="row gutter-40">
                  <div className="col-md-6 col-lg-4">
                    <div className="help-list-block">
                      <h3 className="help-list-title">Riding with Gothi</h3>
                      <ul className="help-list">
                        ...
                        <li className="help-list-item">
                          <a href="#">Accidents and Insurance </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Choose a Ride Type </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Ride Features </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">After Rides </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Ride Fare and Discounts </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">All articles about Riding with Gothi. </a>
                        </li>
                      </ul>
                    </div>
                  </div>{/* end col */}
                  <div className="col-md-6 col-lg-4">
                    <div className="help-list-block">
                      <h3 className="help-list-title">Driving with Gothi</h3>
                      <ul className="help-list">
                        <li className="help-list-item">
                          <a href="#">Requirements and applying </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Accidents and Insurance </a>
                        </li>
                        ...
                        <li className="help-list-item">
                          <a href="#">How to Give Rides </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Hot Spots </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Cancelations and Tolls </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Ride Types </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">All articles about Driving with Gothi. </a>
                        </li>
                      </ul>
                    </div>
                  </div>{/* end col */}
                  <div className="col-md-6 col-lg-4">
                    <div className="help-list-block">
                      <h3 className="help-list-title">Account and Profile</h3>
                      <ul className="help-list">
                        <li className="help-list-item">
                        ...
                        <li className="help-list-item">
                          <a href="#">Update Driver and Vehicle info. </a>
                        </li>
                        <li className="help-list-item">
                        ...
                        <li className="help-list-item">
                          <a href="#">All articles about profile and account </a>
                        </li>
                      </ul>
                    </div>
                  </div>{/* end col */}
                  <div className="col-md-6 col-lg-4">
                    <div className="help-list-block">
                      <h3 className="help-list-title">Earnings and Promos</h3>
                      <ul className="help-list">
                        <li className="help-list-item">
                          <a href="#">Get paid </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Bonuses and Incentives </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Referral Bonuses </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Earning and Tax info </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Driver Rewards </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Passenger Perks and Reward </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Other Programs </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">All articles about Earning and Promos </a>
                        </li>
                      </ul>
                    </div>
                  </div>{/* end col */}
                  <div className="col-md-6 col-lg-4">
                    <div className="help-list-block">
                      <h3 className="help-list-title">Policies and Other Info</h3>
                      <ul className="help-list">
                        <li className="help-list-item">
                        ...
                        <li className="help-list-item">
                          <a href="#">Accessibility in the Gothi App and Website </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Recruiting and Partnerships </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Terms of Conditions and Legal </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">All articles about Policies and Other Info </a>
                        </li>
                      </ul>
                    </div>
                  </div>{/* end col */}
                  <div className="col-md-6 col-lg-4">
                    <div className="help-list-block">
                      <h3 className="help-list-title">Bus Counter and airport Info</h3>
                      <ul className="help-list">
                        <li className="help-list-item">
                          <a href="#">Bangladesh Airport Regulations for Drivers </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">BD Bus Counter Regulations for Drivers </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Bus Counter and Airport info for Passengers </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">Bus Counter and Airport info for Drivers </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">All articles about Bus Counter info </a>
                        </li>
                        <li className="help-list-item">
                          <a href="#">All articles about Airport info </a>
                        </li>
                      </ul>
                    </div>
                  </div>{/* end col */}
            ...
            <div className="section-padding help-needed">
              <div className="container">
                <h2 className="section-title help-needed-title text-center mb-40">Choose the type of help you need</h2>
                <div className="row gutter-40 justify-content-center">
                  <div className="col-lg-4 col-md-6">
                    <div className="help-type">
                      <div className="help-type-content">
                        <h3 className="help-type-title">
                          <a href="#">Riding with Gothi</a>
                        </h3>
                        <div className="help-type-thumbs">
                ...
                <div className="row">
                  <div className="col-md-10 mx-auto">
                    <div className="help-wrap-button d-flex flex-wrap justify-content-around">
                      <a href="tel:+8801842062012" className="btn mb-20 minWidth_200">WhatsApp</a>
                      <a href="tel:+8801842062012" className="btn mb-20 minWidth_200">Contact Us</a>
                    </div>
                  </div>{/* end col */}
                </div>{/* end row */}
              </div>{/* end container */}
