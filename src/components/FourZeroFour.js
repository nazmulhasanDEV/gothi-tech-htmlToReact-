...
export class FourZeroFour extends Component {
    render() {
        return (
          ...
          <main>
            {/* start banner */}
            <section className="banner banner_4" style={{backgroundImage: 'url("./assets/img/banner_bg.png")'}}>
              <div className="container">
                <div className="row align-items-center gutter-40">
                  <div className="col-lg-6">
                    <div className="banner-caption">
                      ...
                      <span className="banner-subtitle mt-30">
                        Not to worry, why don't you
                        try one of these helpful link
                      </span>
                      <div className="btn-wrap banner-btn mt-40">
                        <a href="#" className="btn me-2">go to home</a>
                        <a href="#" className="btn min-180">blog</a>
                      </div>
                    </div>
                  </div>{/* end col */}
                  <div className="col-lg-6">
                    <div className="banner2-img">
                      <img src="assets/img/banner_404.png" className="img-fluid" alt="" />
                    </div>
                  </div>{/* end col */}
                </div>{/* end row */}
              </div>{/* end container */}
            </section>{/* end banner */}
            {/* start banner-bottom wrapper */}
            <div className="banner-bottom-wrapper">
            </div>{/* end banner-bottom wrapper */}
          </main>
          {/* footer */}
