...
export class About extends Component {
    render() {
        return (
          ...
          <main>
            {/* start banner */}
            <section className="banner banner_3 overlayB50 banner_about">
              <div className="container">
                <div className="row justify-content-end">
                  <div className="col-12 ">
                    <div className="banner-caption">
                      <h1 className="banner-title banner-title2 title_3">
                        About Gothi
                      </h1>
                    </div>
                  </div>
                ...
                <div className="row text-center">
                  <div className="col-lg-10 mx-auto">
                    <h2 className="section-title mb-0 white-color">
                      We foster opportunity by setting the world in move.
                      Gothi’s service for all.
                    </h2>
                  </div>
                </div>{/* end row */}
              </div>{/* end container */}
            </section>{/* end section */}
            <section className="section-padding bg_gray">
              <div className="container">
                <div className="row gutter-30">
                  <div className="col-12 wow fadeInUp">
                    <div className="rider-content">
                      <h4 className="content-title mb-0">
                        Through our Gothi initiative, we’re working to make sure everyone has access to
                        affordable, reliable transportation &amp; Gothi Service to get where they need to
                        go — no matter their age. Good things happen when people can move, whether across town
                        or toward their dreams. Opportunities appear, open up, become
                        reality. What started as a way to tap a button to get a ride has l ed to billions of
                        moments of human connection as people around the world go all kinds of
            ...
            <section className="ceo-message-banner banner banner_3 overlayB50 section-padding">
              <div className="container">
                <div className="row">
                  <div className="col-lg-6 col-md-10">
                    <div className="banner-caption ceo-banner-caption">
                      ...
                      <p className="mb-40">
                        Infinite gratitude to the Most Merciful Allah; Who has given us the opportunity
                        to roam the earth as sentient beings. Gothi is the product
                        of the creative talent and long three years of
                        tireless work of a group of promising young people in this country.
                      </p>
            ...
            </section>{/* end ceo message banner */}
            <section className="py-5 bg_gray">
              <div className="container">
                <div className="row">
                  <div className="col-md-6">
                    <div className="banner-caption">
                      <h3 className="banner-title mb-20 text-decoration-underline">
                        <a href="#" className="color_secondary"> Leadership</a>
                      </h3>
                      <p>
                  ...
                  <div className="col-md-6 text-md-end">
                    <div className="banner-caption">
                      <h3 className="banner-title mb-0 text-decoration-underline ">
                        <a href="#" className="color_secondary"> Director's</a>
                      </h3>
                    </div>
                  </div>{/* end col */}
                </div>{/* end row */}
            ...
            {/* start banner_about3 */}
            <section className="banner banner_3 overlayB50 banner_about3">
            </section>{/* end banner_about3 */}
            {/* start feature */}
            <section className="feature-section bg_gray section-padding">
              <div className="container">
                <div className="row gutter-30">
                  <div className="col-lg-4 col-md-6 wow fadeInUp">
                    <div className="feature feature_type3">
                      ...
                      <p>
                        We strengthen Gothi’s position as a leading mobility
                        platform through creative and mutually commercial
                        partnerships that unlock outsized value today.
                      </p>
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp">
                    <div className="feature feature_type3">
                      ...
                      <p>
                        We are responsible for working with media, policy makers and third parties to explain
                        why Gothi is great for riders, drivers and cities.
                      </p>
                      <div className="feature-btn">
                        <a href="#" className="read-more">Learn More</a>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp">
                    <div className="feature feature_type3">
                      ...
                      <p>
                        We are responsible for working with media, policy
                        makers and third parties to explain why Gothi is great
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp">
                    <div className="feature feature_type3">
                      ...
                      <p>
                        We build the technologies that power our platform and ignite opportunities for users
                        worldwide.
                      </p>
                      <div className="feature-btn">
                        <a href="#" className="read-more">Learn More</a>
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp">
                    <div className="feature feature_type3">
                      ...
                      <p>
                        We work across the company to bring the Uber brand
                        to life, both inside and outside our walls.
                      </p>
                      <div className="feature-btn">
                        <a href="#" className="read-more">Learn More</a>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp">
                    <div className="feature feature_type3">
                      ...
                      <p>
                        We are working to redefine what safety on the road
                        means on an international scale. We provide Rider and
                        Driver Health insurance Facility.
                      </p>
                      <div className="feature-btn">
                        <a href="#" className="read-more">Learn More</a>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp">
                    <div className="feature feature_type3">
                      ...
                      <p>
                        We are committed to growing Gothi by identifying new partners, managing existing
                        relationships, and creating value for both the customer and Gothi.
                      </p>
                      <div className="feature-btn">
                        <a href="#" className="read-more">Learn More</a>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6 wow fadeInUp">
                    <div className="feature feature_type3">
                      ...
                      <p>
                        We are dedicated to enabling safe and secure
                        innovation while protecting the communities we serve
            ...
            <section className="cta section-padding">
              <div className="container">
                <div className="row gutter-30 justify-content-between align-items-center">
                  <div className="col-md-6 col-xxl-6 wow fadeInUp">
                    <div className="banner-caption">
                      <h2 className="banner-title color_secondary mb-30">
                        Making Big Change With Your Small Change
                      </h2>
                      <p className="mb-30">
                        Everyone can help us bring affordable, reliable transportation &amp; Gothi Service to all.
                        Join Gothi by choosing an organization to donate to i n the Gothi’s Platform — we'll
                        round up the cost of your ride to the nearest amount and donate the difference.
                      </p>
                      <div className="btn-wrap">
                        <a href="#" className="btn btn-reverse">Join Now</a>
                      </div>
                    </div>
                  </div>{/* end col */}
                  <div className="col-md-6 col-xxl-5 wow fadeInUp">
                    <div className="partner-gallery-thumbs">
                      <img src="assets/img/about_img3.jpg" className="img-fluid" alt="" />
            ...
            <div className="offering-head bg_black py-5">
              <div className="container">
                <div className="row text-center">
                  <div className="offter-caption">
                    <h2 className="color_white">Offerings</h2>
                    <p className="color_white mb-0">Read about the teams behind Gothi’s products &amp; services.</p>
                  </div>
                </div>{/* end row */}
              </div>{/* end container */}
                ...
                <div className="row gutter-30 justify-content-between">
                  <div className="col-md-6  wow fadeInUp">
                    <div className="blog ">
                      <div className="blog-thumbs">
                        <a href="#">
                          <img src="assets/img/offer_thumbs1.jpg" className="img-fluid" alt="" />
                        </a>
                      </div>
                      <div className="blog-content blog-offer-content">
                        <h3 className="blog-title">
                          <a href="#">Ridesharing</a>
                        </h3>
                        <p>
                          Tap a button, get a ride. Ridesharing is the original Gothi
                          product that continues to move millions of people around
                          the world every day.
                        </p>
                        <a href="#" className="read-more">Learn more</a>
                      </div>
                  ...
                  <div className="col-md-6  wow fadeInUp">
                    <div className="blog">
                      <div className="blog-thumbs">
                        <a href="#">
                          <img src="assets/img/offer_thumbs2.jpg" className="img-fluid" alt="" />
                        </a>
                      </div>
                      <div className="blog-content blog-offer-content">
                        <h3 className="blog-title">
                          <a href="#">Gothi Services</a>
                        </h3>
                        <p>
                          Whether it’s a Workshop, Vehicle Mechanical Service or Servicing, the Gothi Service
                          team builds technology to connect people with what they want, when and `where they
                          want it.
                        </p>
                        <a href="#" className="read-more">Learn more</a>
                      </div>
                  ...
                  <div className="col-md-6  wow fadeInUp">
                    <div className="blog ">
                      <div className="blog-thumbs">
                        <a href="#">
                          <img src="assets/img/offer_thumbs3.jpg" className="img-fluid" alt="" />
                        </a>
                      </div>
                      <div className="blog-content blog-offer-content ex-offer-con">
                        <h3 className="blog-title">
                          <a href="#">Gothi For Festival</a>
                        </h3>
                        <p>
                          The Festival partner i s building a better future for the Marries program, study
                          tour &amp;
                          others. We believe that when festivals have the freedom to move together, the entire
                          program moves ahead.
                        </p>
                        <a href="#" className="read-more">Learn more</a>
                      </div>
                  ...
                  <div className="col-md-6  wow fadeInUp">
                    <div className="blog">
                      <div className="blog-thumbs">
                        <a href="#">
                          <img src="assets/img/offer_thumbs4.jpg" className="img-fluid" alt="" />
                        </a>
                      </div>
                      <div className="blog-content blog-offer-content">
                        <h3 className="blog-title">
                          <a href="#">Gothi for Business</a>
                        </h3>
                        <p>
                          We’re simplifying the way businesses move. Help us bring modern ground
                          transportation management to businesses and corporate service around the globe.
                          We provide many kinds of vehicles for business development.
                        </p>
                        <a href="#" className="read-more">Learn more</a>
                      </div>
                    </div>
            ...
            <section className="about-business bg_gray section-padding">
              <div className="container">
                <div className="row gutter-30 justify-content-between align-items-center">
                  <div className="col-md-6 col-xxl-6 wow fadeInUp">
                    <div className="about-block">
                      <span className="sub-title">GOTHI COMMUNITY GRANTS</span>
                      <h2 className="section-title title3 ">
                        Supporting Local Organizations &amp; Poor People Of Bangladesh:
                      </h2>
                      <p>
                        Transportation access can be a big help for grassroots organizations that address our
                        most important urban challenges. We support them with Gothi Community Grants from
                        Gothi’s welfare fund of up to 20lacs in free or discounted rides. Some of our Gothi
                        Community Grant recipients include the Distribution of winter cloth for poor community,
                        National Mental Health, Women's Resource Center to End
                        Domestic Violence.
                      </p>
                  ...
                  <div className="col-md-6 col-xxl-5 wow fadeInUp">
                    <div className="about-business-img">
                      <img src="assets/img/about_img2.jpg" className="img-fluid" alt="" />
                    </div>
                  </div>{/* end col */}
                </div>{/* end row */}
              </div>{/* end container */}
